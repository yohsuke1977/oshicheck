...
function setupPlatformSwitch() {
  document.querySelectorAll('input[name="platform"]').forEach(r => {
    r.addEventListener('change', () => {
      ...
      const key = { youtube: 'Youtube', twitch: 'Twitch', twitcasting: 'Twitcasting', showroom: 'Showroom', whowatch: 'Whowatch', niconico: 'Niconico', '17live': 'Seventeen', kick: 'Kick' }[r.value];
